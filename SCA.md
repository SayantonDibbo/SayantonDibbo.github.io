  ...
  <div class="container is-max-desktop">
    <div class="hero-body">
      ...
      <h2 class="subtitle has-text-centered">
        We provide the first study of neural network architectures that are robust to model inversion attacks. We develop a novel sparse coding-based architecture, SCA , that outperforms state-of-the-art defenses.
      </h2>
    </div>
  </div>
</section>
